...
def compute_advantage(gamma, lmbda, td_delta):
    ...
    for delta in td_delta[::-1]:
        ...
        advantage_list.append(advantage)  # td_delta列表中越在后面的前面乘的系数和后面加的东西越少
...
class TRPOContinuous:
    ...
    def hessian_matrix_vector_product(self, states, old_action_dists, vector, damping=0.1):
        ...
        return grad2_vector + damping * vector  # (H+λI)v 为了数值稳定性加λI
    ...
    def update(self, transition_dict):
        ...
        rewards = (rewards + 8.0) / 8.0  # 对奖励进行归一化,方便训练，[−16,0]→[−1,1]
